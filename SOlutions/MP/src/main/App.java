...
import spark.Spark;
import blackout.BlackoutController;
import blackout.FileTransferException;
...
/**
 * A threadsafe wrapper around your BlackoutController.
    ...
    public static void main(String[] args) throws Exception {
        ...
        Spark.put("/api/device/", "application/json", (request, response) -> {
            ...
            synchronized (bc) {
                ...
                bc.createDevice(request.queryParams("deviceId"), request.queryParams("type"), position);
                return "";
            }
        }, gson::toJson);
