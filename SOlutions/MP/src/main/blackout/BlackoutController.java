...
import blackout.Device.DesktopDevice;
import blackout.File.File;
import blackout.Satellite.RelaySatellite;
import blackout.Satellite.Satellite;
import blackout.Device.Device;
import blackout.Device.HandheldDevice;
import blackout.Device.LaptopDevice;
import blackout.Satellite.ShrinkingSatellite;
import blackout.Satellite.StandardSatellite;
    ...
    public void sendFile(String fileName, String fromId, String toId) throws FileTransferException {
        ...
        if (sourceD != null) {
            ...
            if (!destS.canDownload()) {
                throw new FileTransferException.VirtualFileNoBandwidthException(destS.getSatelliteId());
            }

            // If the destinaton setallite is full
            if (destS.isStorageFull(sourceD.getFileContent(fileName).length())) {
                throw new FileTransferException.VirtualFileNoStorageSpaceException(destS.storageFull());
            }
        ...
        // If the file is from a satellite
            ...
            if (!sourceS.canUpload()) {
                throw new FileTransferException.VirtualFileNoBandwidthException(sourceS.getSatelliteId());
            }
